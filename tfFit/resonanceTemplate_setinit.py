...
param=loadparam("Dst02300_Dst12600_1462470012_2_29_14_12")


resData =[
        [0, "Dst02300","BW",(param["mDst02300"][0], 0.05, 0.0001 ),(param["gDst02300"][0],0.05, 0.0001),0, () ],    # if set amplitude initials, set amp=( Re(sCentral,sWidth, step), Im(.. ,.. ,.. )), otherwise set : () , and the amp will be random from (-10,10)
        #[0, "Dst22460","BW",(2.4611,),(0.0473,), 2,((param["Dst22460R"][0], 5*param["Dst22460R"][1], 0.0001), (param["Dst22460I"][1], 5*param["Dst22460I"][1], 0.0001)  )],
        #[0, "Dst12600","BW",(param["mDst12600"][0], 0.1, 0.00001 ),(param["gDst12600"][0], 0.07, 0.0001),1,((param["Dst12600R"][0], 5*param["Dst12600R"][1], 0.00001), (param["Dst12600I"][0], 5*param["Dst12600I"][1], 0.00001) )],   

        #[0, "Dst22460","BW",(2.4611,),(0.0473,), 2,((param["Dst22460R"][0], 0.1, 0.0001), (param["Dst22460I"][1], 0.1, 0.0001)  )],
        [0, "Dst22460","BW",(2.4611,),(0.0473,), 2, () ],
        [0, "Dst12600","BW",(param["mDst12600"][0], 0.05, 0.00001 ),(param["gDst12600"][0], 0.05, 0.0001),1,((param["Dst12600R"][0], 0.1, 0.00001), (param["Dst12600I"][0], 0.1, 0.00001) )],   
...
NonRes0 = {
        ...
        "lineshape"   : ExponentialNonResonantLineShape,
        "spin"      : 0, 
        "slope" :   buildLineParameter("NonRes0Slope",(param["NonRes0Slope"][0], 0.01, 0.00001)),
        "coupling"  :   Complex(buildLineParameter("NonRes0R",(param["NonRes0R"][0],0.1, 0.00001)),
                                buildLineParameter("NonRes0I",(param["NonRes0I"][1],0.1, 0.00001))
                                )
        } 
