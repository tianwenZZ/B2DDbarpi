...
#gROOT.ProcessLine(".x /home/zhoutw/workdir/B2DDbarpi/git-repo/selection/tools/custom_pdf/RooDCBPdf.cxx")
...
def fit(input_files, input_tree_name, mode, in_func,  out_func, output_files ):
    ...
    #sigma = RooRealVar("sigma", "sigma", 8.9, 0.1, 20)
    ...
    def DrawAll(xframe, xx, drawleg=True):
        ...
        if drawleg:
            ...
            leg.AddEntry(xframe.findObject("Total fit"), "Cruijff function", "l")
            leg.Draw()
        can.cd()
