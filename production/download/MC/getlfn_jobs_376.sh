...
if [ -f Tuple_0.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918642/Tuple.root
...
if [ -f Tuple_1.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918643/Tuple.root
...
if [ -f Tuple_2.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918644/Tuple.root
...
if [ -f Tuple_3.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918645/Tuple.root
...
if [ -f Tuple_4.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918646/Tuple.root
...
if [ -f Tuple_5.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918647/Tuple.root
...
if [ -f Tuple_6.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828918/828918649/Tuple.root
