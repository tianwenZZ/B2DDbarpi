...
if [ -f Tuple_0.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828891/828891366/Tuple.root
...
if [ -f Tuple_1.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828891/828891369/Tuple.root
...
if [ -f Tuple_2.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828891/828891370/Tuple.root
...
if [ -f Tuple_3.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828891/828891372/Tuple.root
