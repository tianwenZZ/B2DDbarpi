...
if [ -f Tuple_0.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895376/Tuple.root
...
if [ -f Tuple_1.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895378/Tuple.root
...
if [ -f Tuple_2.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895380/Tuple.root
...
if [ -f Tuple_3.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895383/Tuple.root
...
if [ -f Tuple_4.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895386/Tuple.root
...
if [ -f Tuple_5.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895388/Tuple.root
