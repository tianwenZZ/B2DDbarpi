...
if [ -f Tuple_0.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895066/Tuple.root
...
if [ -f Tuple_1.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895068/Tuple.root
...
if [ -f Tuple_2.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895070/Tuple.root
...
if [ -f Tuple_3.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895073/Tuple.root
...
if [ -f Tuple_4.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895075/Tuple.root
...
if [ -f Tuple_5.root ]; then
   ...
   lb-dirac dirac-dms-get-file /lhcb/user/t/tzhou/2023_12/828895/828895077/Tuple.root
